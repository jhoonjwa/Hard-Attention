...
def run_llava_with_attention(args):
    ...
    for idx, data in tqdm(enumerate(dataset)):
        ...
        qs = question
        output, input_tokens, output_tokens, weights_matrix, autoregressive_mask, image_attentions, input_output_attention = generate_for_attention(args, qs, image_features, tokenizer, model, model_name, args.conv_mode)            
